...
// red, green, blue, yellow, purple, pink, orange, green, indigo, gray, coolGray, trueGray, warmGray, cyan, fuchsia, rose
  ...
  return (
    <div className="flex flex-col p-4 w-full border-dashed border border-zinc-600 hover:border-zinc-400 md:hover:scale-110 duration-300 hover:bg-zinc-900 z-0 hover:z-10">
      <div className="flex items-center justify-between">
        <p className="text-green-300 font-bold text-base">{feature.title}</p>
        {feature.comingSoon && (
          <span className="text-green-400 bg-green-700/30 border-green-600/50 border rounded uppercase text-[9px] px-2 py-1">
            Coming Soon{' '}
          </span>
        )}
      </div>
